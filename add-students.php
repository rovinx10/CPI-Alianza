                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="row" method="post">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="radio" name="gender" value="Male" required="required" checked=""> Másculino <input type="radio" name="gender" value="Female" required="required"> Femenino <input type="radio" name="gender" value="Other" required="required"> Otro
